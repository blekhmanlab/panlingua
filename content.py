...
text = {
    'en': {
        ...
        'affiliation': 'Part of the Rxivist project',
        'jswarning': 'JavaScript is required for this page to function.',
        'description': 'PanLingua enables you to search in your own language for pre-prints on bioRxiv.org. It uses Google Translate to provide machine-generated translations of your query and the manuscripts.',
